import { DropzoneWithoutClick, DropzoneWithoutDrag, DropzoneWithoutKeyboard, OuterDropzone, StopPropagation } from '../../components/examples'
...
function InnerDropzone() {
    ...
    return <div {...getRootProps({ className: 'dropzone' })}><p>Inner dropzone</p></div>;
}
